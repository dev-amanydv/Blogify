                            ...
                            />
                                ...
                                <div className="w-full mt-4 mb-4 border border-gray-200 rounded-lg bg-gray-50 ">
                                    ...
                                    <div className="px-4 py-2 bg-white rounded-b-lg">
                                        ...
                                        }} id="editor" rows={8} className="block w-full px-2 py-2 text-sm text-gray-800 bg-white border-0 focus:ring-0 outline-none " placeholder="Write an article..." required ></textarea>
                                    </div>
                                </div>
